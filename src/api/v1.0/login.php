...
$pass = $_POST["passw"];
    ...
    if($nr==1){
        if($nombre == "admin"){
            echo "<script>window.location='../../app/admin.html'; alert('Bienvenido administrador')</script>";
        }
        else if($nombre == "Mariano"){
            echo "<script>window.location='../../app/userPage1.html?usuario=2'; alert('Bienvenido $nombre')</script>";
        }
        else if($nombre == "Manolo"){
            echo "<script>window.location='../../app/userPage2.html?usuario=3'; alert('Bienvenido $nombre')</script>";
        }
    }
    else{
